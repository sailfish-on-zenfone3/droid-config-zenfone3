# DisplayName: Jolla zenfone3/@ARCH@ (release) 1
# KickstartType: release
# DeviceModel: zenfone3
# DeviceVariant: zenfone3
# Brand: Jolla
...
%packages
patterns-sailfish-device-configuration-zenfone3
%end

%attachment
### Commands from /tmp/sandbox/usr/share/ssu/kickstart/attachment/zenfone3
